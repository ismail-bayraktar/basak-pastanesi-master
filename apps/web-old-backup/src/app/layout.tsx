...
export const metadata: Metadata = {
  title: "Basak Pastanesi İzmir Baklava | Geleneksel Lezzet",
  ...
  keywords: "baklava, başak pastanesi, İzmir baklava, online baklava, tatlı sipariş",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="tr">
      <head>
        {/* Google Fonts - Başak Pastanesi Design System */}
