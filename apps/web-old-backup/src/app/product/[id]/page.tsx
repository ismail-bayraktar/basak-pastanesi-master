            ...
            <div className="lg:sticky lg:top-24 lg:self-start space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium text-basak-golden">
                    {product?.category?.name}
                  </span>
                  {product?.bestseller && (
                    <span className="px-2 py-1 bg-basak-golden/10 text-basak-golden text-xs font-medium rounded-full">
                      Çok Satan
                    </span>
                  )}
                </div>
              ...
              <div className="py-4 border-y border-neutral-100">
                <div className="flex items-baseline gap-3">
                  <span className="text-4xl font-black text-basak-golden">
              ...
              <div className="space-y-3 pt-2">
                <Button
                  ...
                  className="w-full h-14 bg-basak-golden hover:bg-basak-golden/90 text-white text-lg font-semibold rounded-full"
                >
              ...
              <div className="grid grid-cols-2 gap-4 pt-6 border-t border-neutral-100">
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 rounded-full bg-basak-golden/10 flex items-center justify-center flex-shrink-0">
                    <Truck className="w-5 h-5 text-basak-golden" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 rounded-full bg-basak-golden/10 flex items-center justify-center flex-shrink-0">
                    <Shield className="w-5 h-5 text-basak-golden" />
                  </div>
                  <div>
          ...
          <div className="border-b border-neutral-200 bg-white">
            <div className="container mx-auto max-w-7xl px-4">
              <TabsList className="w-full justify-start bg-transparent rounded-none p-0 h-auto border-0">
                <TabsTrigger
                  value="description"
                  className="px-6 py-4 rounded-none data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-basak-golden data-[state=active]:text-basak-golden"
                >
                  Ürün Açıklaması
                </TabsTrigger>
                <TabsTrigger
            ...
            <TabsContent value="reviews" className="py-8 m-0 space-y-8">
              ...
              <div className="bg-white rounded-2xl p-8 border border-neutral-200">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="text-center md:border-r border-neutral-200">
                    <div className="text-5xl font-black text-basak-golden mb-2">4.8</div>
                    <div className="flex items-center justify-center gap-1 mb-2">
                      {[...Array(5)].map((_, i) => (
                        <span key={i} className={`text-2xl ${i < 5 ? 'text-basak-golden' : 'text-neutral-300'}`}>★</span>
                      ))}
                    </div>
                    ...
                    {[5, 4, 3, 2, 1].map((star) => (
                      <div key={star} className="flex items-center gap-3">
                        ...
                        <div className="flex-1 h-2 bg-neutral-100 rounded-full overflow-hidden">
                          <div
                            className="h-full bg-basak-golden"
                ...
                <form className="space-y-6">
                    ...
                    <div className="flex items-center gap-2">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <button
                          key={star}
                          type="button"
                          className="text-3xl text-neutral-300 hover:text-basak-golden transition-colors"
                        >
                          ★
                        </button>
                      ))}
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 border border-neutral-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-basak-golden/20 focus:border-basak-golden"
                    />
                  </div>
                  ...
                  <Button type="submit" className="bg-basak-golden hover:bg-basak-golden/90 text-white rounded-full px-8">
                    Yorum Gönder
                  </Button>
                </form>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white rounded-2xl p-6 border border-neutral-200">
                  <div className="flex items-start gap-4 mb-4">
                    <div className="w-12 h-12 rounded-full bg-basak-golden/10 flex items-center justify-center flex-shrink-0">
                      <span className="font-bold text-basak-golden">AY</span>
                    </div>
                      ...
                      <div className="flex items-center justify-between mb-2">
                        <div>
                          ...
                          <div className="flex items-center gap-1">
                            {[...Array(5)].map((_, i) => (
                              <span key={i} className="text-basak-golden text-lg">★</span>
                            ))}
                          </div>
                        </div>
                ...
                <div className="bg-white rounded-2xl p-6 border border-neutral-200">
                  <div className="flex items-start gap-4 mb-4">
                    <div className="w-12 h-12 rounded-full bg-basak-golden/10 flex items-center justify-center flex-shrink-0">
                      <span className="font-bold text-basak-golden">MK</span>
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-2">
                        <div>
