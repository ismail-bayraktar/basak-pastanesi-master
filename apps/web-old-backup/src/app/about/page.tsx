...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Basak Pastanesi Baklava Yapımı"
            fill
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-6 leading-tight">
              Bir İzmir <span className="text-basak-golden">Masalı.</span>
            </h1>
      ...
      <section className="py-24 bg-neutral-50">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-8">
            ...
            <span className="text-basak-golden">bir kültür mirasıdır.</span>"
          </h2>
          <p className="text-lg text-neutral-600 leading-relaxed">
            Basak Pastanesi olarak biz, bu mirası korumak ve gelecek nesillere aktarmak için yola çıktık.
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group relative h-[500px] rounded-2xl overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 p-8 text-white">
                <ChefHat className="w-10 h-10 text-basak-golden mb-4" />
            ...
            <div className="group relative h-[500px] rounded-2xl overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent" />
              <div className="absolute bottom-0 left-0 p-8 text-white">
                <Leaf className="w-10 h-10 text-basak-golden mb-4" />
            ...
            <div className="group relative h-[500px] rounded-2xl overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent" />
              <div className="absolute bottom-0 left-0 p-8 text-white">
                <Clock className="w-10 h-10 text-basak-golden mb-4" />
      ...
      {/* Stats / Trust Section */}
      <section className="py-20 bg-basak-golden/5 border-y border-basak-golden/10">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="space-y-2">
              <h4 className="text-4xl md:text-5xl font-black text-basak-golden">35+</h4>
              <p className="text-sm font-medium text-neutral-600 uppercase tracking-wider">Yıllık Tecrübe</p>
            </div>
            <div className="space-y-2">
              <h4 className="text-4xl md:text-5xl font-black text-basak-golden">100%</h4>
              <p className="text-sm font-medium text-neutral-600 uppercase tracking-wider">Doğal İçerik</p>
            </div>
            <div className="space-y-2">
              <h4 className="text-4xl md:text-5xl font-black text-basak-golden">50K+</h4>
              <p className="text-sm font-medium text-neutral-600 uppercase tracking-wider">Mutlu Müşteri</p>
            </div>
            <div className="space-y-2">
              <h4 className="text-4xl md:text-5xl font-black text-basak-golden">24s</h4>
          ...
          <div className="bg-neutral-900 rounded-3xl overflow-hidden text-white">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-12 md:p-20 flex flex-col justify-center space-y-8">
                <div>
                  <span className="text-basak-golden font-medium tracking-widest uppercase text-sm">Kurumsal Çözümler</span>
                ...
                <ul className="space-y-4">
                  <li className="flex items-center gap-3">
                    <Award className="text-basak-golden" />
                    <span>Özel logolu kutu tasarımı</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <Truck className="text-basak-golden" />
                    <span>Çoklu adrese eş zamanlı teslimat</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <Heart className="text-basak-golden" />
