    ...
    return (
        <section className="py-20 bg-neutral-50">
            <div className="container mx-auto px-4">
                ...
                >
                    <span className="inline-block py-1 px-3 rounded-full bg-basak-golden/10 text-basak-golden border border-basak-golden/30 text-sm font-medium tracking-wider uppercase mb-4">
                        Öne Çıkan Ürünler
                    </span>
                ...
                <div className="text-center mt-12">
                    <Link href="/collection">
                        <Button
                            size="lg"
                            variant="outline"
                            className="border-2 border-basak-golden text-basak-golden hover:bg-basak-golden hover:text-white rounded-full px-10 h-14 text-lg font-bold transition-all hover:scale-105"
                        >
                            Tüm Ürünleri Gör
                        </Button>
                    </Link>
