...
export function DeliveryFeature() {
    return (
        <section className="py-24 bg-basak-cream overflow-hidden relative">
            {/* Background Pattern */}
            <div className="absolute inset-0 opacity-5 pointer-events-none">
                <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-basak-golden via-transparent to-transparent" />
            </div>

            <div className="container mx-auto px-4">
                <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
                    <span className="text-basak-golden font-bold tracking-wider uppercase text-sm">Özel Kurye Sistemi</span>
                    <h2 className="text-4xl md:text-5xl font-bold text-neutral-900">
                        Sıcacık Baklava, <br />
                        <span className="text-basak-pistachio">Kapınızda.</span>
                    </h2>
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative">
                        ...
                        <div className="space-y-12 relative z-10">
                            ...
                            >
                                <div className="w-16 h-16 rounded-full bg-white border-4 border-basak-golden flex items-center justify-center shadow-lg flex-shrink-0">
                                    <Clock className="w-8 h-8 text-basak-golden" />
                                </div>
                            ...
                            <motion.div
                                ...
                                className="flex gap-8 items-start"
                            >
                                <div className="w-16 h-16 rounded-full bg-white border-4 border-basak-pistachio flex items-center justify-center shadow-lg flex-shrink-0">
                                    <Truck className="w-8 h-8 text-basak-pistachio" />
                                </div>
                                <div className="pt-2 bg-white p-6 rounded-2xl shadow-sm border border-neutral-100 flex-1">
                                    <h3 className="text-xl font-bold text-neutral-900 mb-2">Özel Kurye Yola Çıkar</h3>
                                    <p className="text-neutral-500">Sadece Basak Pastanesi ürünlerini taşıyan özel araçlarımızla, sarsmadan ve soğutmadan yola çıkarız.</p>
                                </div>
                            </motion.div>
                            ...
                            <motion.div
                                ...
                                className="flex gap-8 items-start"
                            >
                                <div className="w-16 h-16 rounded-full bg-basak-golden text-white flex items-center justify-center shadow-lg flex-shrink-0">
                    ...
                    <div className="relative h-[500px] bg-neutral-50 rounded-3xl overflow-hidden shadow-2xl border-8 border-white">
                        ...
                        <div className="absolute bottom-8 left-8 right-8 text-white">
                            <div className="flex items-center gap-2 mb-4">
                                <MapPin className="w-6 h-6 text-basak-pistachio" />
                            ...
                            <div className="flex flex-wrap gap-2">
                                ...
                                <span className="px-3 py-1 rounded-full bg-basak-golden/20 border border-basak-golden/40 text-sm text-basak-golden backdrop-blur-sm">
                                    + Tüm İzmir
                                </span>
                            </div>
                        </div>
