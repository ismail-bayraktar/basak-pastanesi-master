                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8 order-2 lg:order-1">
                        <div className="space-y-4">
                            <span className="text-tulumbak-golden font-bold tracking-wider uppercase text-sm flex items-center gap-2">
                                <span className="w-8 h-[2px] bg-tulumbak-golden"></span>
                                Kurumsal Kimlik
                            </span>
                            <h2 className="text-4xl md:text-5xl font-bold text-neutral-900 leading-tight">
                                1985'ten Beri <br />
                                <span className="text-tulumbak-pistachio">Ustalık ve Güven.</span>
                            </h2>
                            <p className="text-neutral-600 leading-relaxed text-lg">
                                Tulumbak olarak, dededen toruna geçen baklava ustalığını modern gıda güvenliği standartlarıyla birleştiriyoruz.
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                            <div className="flex gap-4 items-start">
                                <div className="w-12 h-12 rounded-full bg-tulumbak-pistachio/10 flex items-center justify-center flex-shrink-0">
                                    <Leaf className="w-6 h-6 text-tulumbak-pistachio" />
                                </div>
                                <div>
                            ...
                            <div className="flex gap-4 items-start">
                                <div className="w-12 h-12 rounded-full bg-tulumbak-golden/10 flex items-center justify-center flex-shrink-0">
                                    <Award className="w-6 h-6 text-tulumbak-golden" />
                                </div>
                                <div>
                        ...
                        <div className="pt-4">
                            <Button variant="link" className="text-tulumbak-pistachio p-0 h-auto font-bold text-lg group">
                    ...
                    <div className="relative order-1 lg:order-2">
                        ...
                        <div className="absolute -bottom-8 -left-8 bg-white p-6 rounded-xl shadow-xl max-w-[200px] hidden md:block">
                            <div className="text-4xl font-bold text-tulumbak-golden mb-1">35+</div>
