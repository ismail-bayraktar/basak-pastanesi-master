    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-neutral-200/50 shadow-sm">
      <div className="w-full max-w-[1400px] mx-auto px-4 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link
            href="/"
            className="text-neutral-800 hover:text-tulumbak-golden transition-colors font-medium"
          >
            Ana Sayfa
          </Link>
          ...
          <DropdownMenu modal={false}>
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-1 text-neutral-800 hover:text-tulumbak-golden transition-colors font-medium">
                Ürünler
                <ChevronDown size={16} />
              </button>
            </DropdownMenuTrigger>
        ...
        <div className="flex items-center gap-4">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="hover:text-tulumbak-golden"
          ...
          <Button
            variant="ghost"
            size="icon"
            className="relative hover:text-tulumbak-golden"
            onClick={() => useCartStore.getState().setMiniCartOpen(true)}
          >
            <ShoppingCart className="w-5 h-5" />
            {mounted && cartCount > 0 && (
              <span className="absolute -top-1 -right-1 bg-tulumbak-golden text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold">
                {cartCount}
              </span>
            )}
          </Button>
          ...
          <DropdownMenu modal={false}>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="icon" className="hover:text-tulumbak-golden">
        ...
        <div className="absolute top-20 left-0 w-full bg-white border-b border-neutral-200 p-4 shadow-lg animate-in slide-in-from-top-5">
          <div className="max-w-[800px] mx-auto flex gap-2">
            <input
              ...
              className="flex-1 h-12 px-4 rounded-lg border border-neutral-300 focus:outline-none focus:border-tulumbak-golden focus:ring-1 focus:ring-tulumbak-golden"
              value={search}
              ...
              autoFocus
            />
            <Button onClick={handleSearch} className="h-12 px-8 bg-tulumbak-golden hover:bg-tulumbak-golden/90 text-white">
              Ara
            </Button>
          </div>
        </div>
