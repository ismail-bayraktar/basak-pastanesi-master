    ...
    return (
        <section className="relative h-[90vh] w-full overflow-hidden bg-neutral-900">
            ...
            <div className="relative z-10 h-full container mx-auto px-4 flex flex-col justify-center items-center text-center">
                ...
                >
                    <span className="inline-block py-1 px-3 rounded-full bg-tulumbak-golden/20 text-tulumbak-golden border border-tulumbak-golden/30 text-sm font-medium tracking-wider uppercase backdrop-blur-sm">
                    ...
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white tracking-tight leading-tight">
                        {titleParts[0]}
                        {titleParts[1] && ','} <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-tulumbak-golden to-yellow-200">
                            {titleParts[1] || ""}
                        </span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8 relative z-20">
                        <Link href={buttonLink}>
                            <Button
                                size="lg"
                                className="bg-tulumbak-golden hover:bg-orange-600 text-white px-10 h-16 text-lg rounded-full shadow-lg shadow-orange-900/20 transition-all hover:scale-105 border-2 border-transparent"
                            >
                                {ctaPrimary}
                            </Button>
                        </Link>
