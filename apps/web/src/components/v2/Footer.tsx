                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                        ...
                        <div className="flex w-full md:w-auto gap-2">
                            <input
                                ...
                                className="bg-white/5 border border-white/10 rounded-full px-6 py-3 text-white placeholder:text-neutral-500 focus:outline-none focus:border-tulumbak-golden w-full md:w-80"
                            />
                            <Button className="rounded-full bg-tulumbak-golden hover:bg-orange-600 text-white px-6">
                                Abone Ol
                            </Button>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-4">
                            <a href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-tulumbak-golden hover:text-white transition-colors">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            <li>
                                <Link href="/collection" className="hover:text-tulumbak-golden transition-colors flex items-center gap-2 group">
                            ...
                            {categories.slice(0, 5).map((category) => (
                                <li key={category._id}>
                                    <Link
                                        ...
                                        className="hover:text-tulumbak-golden transition-colors flex items-center gap-2 group"
                                    >
                                        <ArrowRight className="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity" />
                                        {category.name}
                                    </Link>
                            ...
                            {topProducts.map((product) => (
                                <li key={product._id}>
                                    <Link
                                        ...
                                        className="hover:text-tulumbak-golden transition-colors"
                                    >
                                        {product.name}
                                    </Link>
                                </li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            <li className="flex items-start gap-3">
                                <MapPin className="w-5 h-5 text-tulumbak-golden shrink-0" />
                                <span>Alsancak Mah. Kıbrıs Şehitleri Cad. No:144, Konak/İzmir</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <Phone className="w-5 h-5 text-tulumbak-golden shrink-0" />
                                <span>+90 (232) 464 12 34</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <Mail className="w-5 h-5 text-tulumbak-golden shrink-0" />
                                <span>info@tulumbak.com</span>
                            </li>
                        </ul>
                    </div>
                </div>
