...
export function MiniCart() {
    ...
    const freeShippingThreshold = 1000 * 100; // 1000 TL in cents
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-2">
                                ...
                                <p className="text-sm text-neutral-600">
                                    Ücretsiz kurye için <span className="font-semibold text-tulumbak-golden">{(remainingForFreeShipping / 100).toFixed(2)} {currency}</span> daha ekleyin
                                </p>
                            </div>
                        ...
                        <ScrollArea className="flex-1 px-6">
                            <div className="py-4 space-y-6">
                                {cartItems.map(({ product, size, quantity }) => {
                                    ...
                                    const sizePrice = sizePrices.find((sp) => String(sp.size) === size);
                        ...
                        <div className="p-6 border-t bg-white space-y-4">
                            <div className="space-y-2">
                                <div className="flex justify-between text-sm">
                                    ...
                                    <span className="font-medium">{(subtotal / 100).toFixed(2)} {currency}</span>
                                </div>
                                <div className="flex justify-between text-sm">
