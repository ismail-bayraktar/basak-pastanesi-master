                ...
                <div className="fixed top-36 right-4 z-50 bg-white p-4 rounded-xl shadow-2xl border border-neutral-200 w-64 animate-in slide-in-from-right-10">
                    ...
                    <div className="space-y-2">
                        <Button
                            ...
                            className={`w-full justify-start ${sliderMode === 'default' ? 'bg-tulumbak-golden hover:bg-orange-600' : ''}`}
                        ...
                        <Button
                            ...
                            className={`w-full justify-start ${sliderMode === 'seasonal' ? 'bg-tulumbak-golden hover:bg-orange-600' : ''}`}
                        ...
                        <Button
                            ...
                            className={`w-full justify-start ${sliderMode === 'promo' ? 'bg-tulumbak-golden hover:bg-orange-600' : ''}`}
