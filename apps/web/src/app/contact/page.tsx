    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-neutral-50 to-white pt-32 pb-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <span className="inline-block py-1 px-3 rounded-full bg-tulumbak-golden/10 text-tulumbak-golden text-xs font-medium tracking-widest uppercase mb-6">
              İletişim
            </span>
            <h1 className="text-4xl md:text-6xl font-black text-neutral-900 tracking-tight mb-6">
              Sizden Haber Almak <br />
              <span className="text-tulumbak-golden">İsteriz.</span>
            </h1>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <a
              ...
              className="group bg-white rounded-2xl p-6 border border-neutral-200 hover:border-tulumbak-golden hover:shadow-lg transition-all duration-300"
            >
              <div className="w-12 h-12 rounded-full bg-tulumbak-golden/10 flex items-center justify-center mb-4 group-hover:bg-tulumbak-golden/20 transition-colors">
                <Phone className="w-6 h-6 text-tulumbak-golden" />
              </div>
              ...
              <span className="text-tulumbak-golden text-sm font-medium group-hover:underline">
                Hemen Ara →
              </span>
            </a>
            ...
            >
              <div className="w-12 h-12 rounded-full bg-tulumbak-golden/10 flex items-center justify-center mb-4 group-hover:bg-tulumbak-golden/20 transition-colors">
                <MessageCircle className="w-6 h-6 text-tulumbak-golden" />
              </div>
            ...
            >
              <div className="w-12 h-12 rounded-full bg-tulumbak-golden/10 flex items-center justify-center mb-4 group-hover:bg-tulumbak-golden/20 transition-colors">
                <Mail className="w-6 h-6 text-tulumbak-golden" />
              </div>
              <h3 className="text-lg font-bold text-neutral-900 mb-2">E-posta</h3>
              <p className="text-neutral-600 text-sm mb-3">info@tulumbak.com</p>
              <span className="text-tulumbak-golden text-sm font-medium group-hover:underline">
                E-posta Gönder →
              </span>
            </a>
            ...
            >
              <div className="w-12 h-12 rounded-full bg-tulumbak-golden/10 flex items-center justify-center mb-4 group-hover:bg-tulumbak-golden/20 transition-colors">
                <MapPin className="w-6 h-6 text-tulumbak-golden" />
              </div>
              ...
              <div className="bg-white rounded-3xl border border-neutral-200 p-8 md:p-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button
                    type="submit"
                    size="lg"
                    className="w-full bg-tulumbak-golden hover:bg-tulumbak-golden/90 text-white h-14 text-lg rounded-full"
                  >
                    Mesajı Gönder
            ...
            <div className="space-y-6">
              ...
              <div className="bg-neutral-50 rounded-2xl p-6 border border-neutral-200">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-full bg-tulumbak-golden/10 flex items-center justify-center">
              ...
              {/* Corporate */}
              <div className="bg-tulumbak-golden/5 rounded-2xl p-6 border border-tulumbak-golden/20">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-full bg-tulumbak-golden/20 flex items-center justify-center">
                ...
                <Button
                  variant="outline"
                  className="w-full border-tulumbak-golden text-tulumbak-golden hover:bg-tulumbak-golden hover:text-white"
                >
                  Detaylı Bilgi
                </Button>
              </div>
